...
document.addEventListener("DOMContentLoaded", function () {
    class User {
        constructor(carica, numeroTelefono, nomeUtente) {
            this.carica = 0;
    ...
    let inEntrata = document.querySelector("#numeroCall");
    let secondi = document.querySelector("#secondiCall");
    let inUscita = document.querySelector("#inoltraCall");
    let registroCall = document.querySelector("#infoCall");
    let canc = document.querySelector("#azzeraCall");
